...
- **Oversee all billing processes within Clio case management software (required).**: Accounts receivable (AR) management at UPS, including transaction tracking and invoice status changes.

- **Review, update, and correct attorney time entries to ensure accuracy and completeness.**: My education in Public Accounting and experience in accounting and financial roles provides a solid foundation for this requirement.

- **Generate and distribute client invoices on a consistent schedule, ensuring accuracy and compliance with firm standards.**: Accounts receivable (AR) management at UPS, including transaction tracking and invoice status changes.

- **Collections & Client Communication**: My education in Public Accounting and experience in accounting and financial roles provides a solid foundation for this requirement.

- **Conduct timely follow-up on unpaid invoices to maintain healthy cash flow.**: Experience in billing and invoicing processes in multiple roles, including invoice filing and document management.
