...
- **Play a key role in delivering quality, on-time billing reports and invoices to customers.**: Preparation of financial and accounting reports using advanced Excel, with experience in process automation.

- **Set up customer billing schedules and procedures.**: Currently taking Power BI training to strengthen data visualization and analysis skills.

- **Process and analyze billing-related data.**: Currently taking Power BI training to strengthen data visualization and analysis skills.

- **Produce invoices and billing reports for Managed Service customers.**: Preparation of financial and accounting reports using advanced Excel, with experience in process automation.

- **Schedule monthly activities with both internal and external teams.**: My education in Public Accounting and experience in accounting and financial roles provides a solid foundation for this requirement.
