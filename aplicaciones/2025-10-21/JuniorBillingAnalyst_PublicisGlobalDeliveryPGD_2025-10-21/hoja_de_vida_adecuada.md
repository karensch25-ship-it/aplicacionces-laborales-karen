...
- **On-boarding of new suppliers and clients to BCC.**: Gestión de cuentas por cobrar (AR) en UPS, incluyendo seguimiento de transacciones y cambios de estado de facturas.

- **Provide shared services team with recoveries for revenue take-up/WIP clearing.**: Gestión de cuentas por cobrar (AR) en UPS, incluyendo seguimiento de transacciones y cambios de estado de facturas.

- **Review completeness and accuracy once posted in ERP System.**: Manejo de SAP y otros sistemas financieros en roles previos, facilitando la adaptación a nuevas plataformas.

- **Resolve and respond to client billing queries.**: Cursando capacitación en Power BI para fortalecer habilidades en visualización de datos y análisis.

- **Resolve issues in supplier invoices/spends files in coordination with the operations team.**: Experiencia en facturación y procesos de billing en múltiples roles, incluyendo radicación de facturas y gestión documental.
