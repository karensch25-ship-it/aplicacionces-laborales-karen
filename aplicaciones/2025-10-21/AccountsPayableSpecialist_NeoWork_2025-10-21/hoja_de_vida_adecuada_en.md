...
- **Maintain and reconcile property-level accounts payable ledgers, validating charges and ensuring payment record accuracy.**: Accounts receivable (AR) management at UPS, including transaction tracking and invoice status changes.

- **Process vendor invoices and payments in line with established policies and deadlines.**: Experience in billing and invoicing processes in multiple roles, including invoice filing and document management.

- **Investigate and resolve billing discrepancies in collaboration with vendors and internal teams.**: Currently taking Power BI training to strengthen data visualization and analysis skills.

- **Serve as the main point of contact for vendor-related inquiries with clear and professional communication.**: Accounts receivable (AR) management at UPS, including transaction tracking and invoice status changes.

- **Set up new vendors and update vendor records within the accounting system.**: Experience with SAP and other financial systems in previous roles, facilitating adaptation to new platforms.
