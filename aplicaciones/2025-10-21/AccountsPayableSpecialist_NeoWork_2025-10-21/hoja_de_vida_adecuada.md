...
- **Maintain and reconcile property-level accounts payable ledgers, validating charges and ensuring payment record accuracy.**: Gestión de cuentas por cobrar (AR) en UPS, incluyendo seguimiento de transacciones y cambios de estado de facturas.

- **Process vendor invoices and payments in line with established policies and deadlines.**: Experiencia en facturación y procesos de billing en múltiples roles, incluyendo radicación de facturas y gestión documental.

- **Investigate and resolve billing discrepancies in collaboration with vendors and internal teams.**: Cursando capacitación en Power BI para fortalecer habilidades en visualización de datos y análisis.

- **Serve as the main point of contact for vendor-related inquiries with clear and professional communication.**: Gestión de cuentas por cobrar (AR) en UPS, incluyendo seguimiento de transacciones y cambios de estado de facturas.

- **Set up new vendors and update vendor records within the accounting system.**: Manejo de SAP y otros sistemas financieros en roles previos, facilitando la adaptación a nuevas plataformas.
