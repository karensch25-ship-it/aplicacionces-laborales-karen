...
- **Perform bookkeeping and accounting tasks for our clients.**: Mi formación en Contaduría Pública y experiencia en roles contables y financieros me proporciona una base sólida para este requerimiento.

- **Assist with day-to-day operations and administrative tasks as needed.**: Mi formación en Contaduría Pública y experiencia en roles contables y financieros me proporciona una base sólida para este requerimiento.

- **Work efficiently to manage and complete assigned tasks.**: Mi formación en Contaduría Pública y experiencia en roles contables y financieros me proporciona una base sólida para este requerimiento.

- **Experience with payroll. E.g. QuickBooks Online.**: Mi formación en Contaduría Pública y experiencia en roles contables y financieros me proporciona una base sólida para este requerimiento.

- **Also assisting with lead generation and experience with lead software e.g. Minichat (Preferred)**: Gestión de cuentas por cobrar (AR) en UPS, incluyendo seguimiento de transacciones y cambios de estado de facturas.
